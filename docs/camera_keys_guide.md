...
Factor Perception SDK 的相机密钥是**硬件绑定**的，每个相机型号对应唯一的密钥。这些密钥不需要保密，因为它们只能用于对应的硬件设备。
...
| 相机型号 | 密钥 | 说明 |
|---------|------|------|
| **OAK-D Pro** | `14442C105168D9D600` | OAK-D Pro 标准版 |
| **OAK-D Pro W** | `12D0C1E7D1AB466C09BD9AE6427D5240` | OAK-D Pro W（宽版）⭐ 当前默认 |
| **OAK-D S2** | `B4C22057DAC5A53595D92CD44D06F91E` | OAK-D S2 |
